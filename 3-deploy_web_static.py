...
import os
from fabric.api import runs_once, local, env, local, put, run

env.hosts = ["54.165.132.79","34.239.254.105"]
...
def deploy():
    """this function combine the do_pack and do_deploy functions"""
    file_path = do_pack()
    if (not file_path):
        return False
